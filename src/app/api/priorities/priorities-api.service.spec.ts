...
describe('PrioritiesApiService', () => {
  ...
  it('create', () => {
    ...
    spectator.expectOne(`${ConfigServiceMock.apiUrl}/priorities`, HttpMethod.POST);
  });
  ...
  it('put', () => {
    ...
    spectator.expectOne(`${ConfigServiceMock.apiUrl}/priorities/${id}`, HttpMethod.PUT);
  });
  ...
  it('patch', () => {
    ...
    spectator.expectOne(`${ConfigServiceMock.apiUrl}/priorities/${id}`, HttpMethod.PATCH);
  });
