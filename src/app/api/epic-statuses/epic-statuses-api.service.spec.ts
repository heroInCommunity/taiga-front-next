...
describe('EpicStatusesApiService', () => {
  ...
  it('create', () => {
    ...
    spectator.expectOne(`${ConfigServiceMock.apiUrl}/epic-statuses`, HttpMethod.POST);
  });
  ...
  it('put', () => {
    ...
    spectator.expectOne(`${ConfigServiceMock.apiUrl}/epic-statuses/${id}`, HttpMethod.PUT);
  });
  ...
  it('patch', () => {
    ...
    spectator.expectOne(`${ConfigServiceMock.apiUrl}/epic-statuses/${id}`, HttpMethod.PATCH);
  });
