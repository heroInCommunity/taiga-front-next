...
describe('TaskStatusesApiService', () => {
  ...
  it('create', () => {
    ...
    spectator.expectOne(`${ConfigServiceMock.apiUrl}/task-statuses`, HttpMethod.POST);
  });
  ...
  it('put', () => {
    ...
    spectator.expectOne(`${ConfigServiceMock.apiUrl}/task-statuses/${id}`, HttpMethod.PUT);
  });
  ...
  it('patch', () => {
    ...
    spectator.expectOne(`${ConfigServiceMock.apiUrl}/task-statuses/${id}`, HttpMethod.PATCH);
  });
